...
sub check_cpan {
    ...
    my %cpan_modules = (
			...
			'Mail::DKIM' => { required_version =>'0.36',
...
";
	...
	'mail::DKIM' => 'requiered in order to use Sympa DKIM features, both for signature verification  and signature insertion. it should be used event if you do not want your server to add signature !',
    );
